  ...
  return (
    <div className="pes-container pes-section">
      ...
      <div className="mt-16 space-y-16">
        {SERVICES.map(({ type, code, title }) => (
          <section key={type} className="grid gap-8 border-t-2 border-navy-900 pt-8 lg:grid-cols-12 lg:gap-10">
            <div className="lg:col-span-4">
              <span className="font-mono text-[11px] tabular-nums text-gold-700">{code}</span>
              ...
              <Link
                ...
                className="mt-6 inline-flex items-center gap-2 border-b-2 border-gold-400 pb-1 font-mono text-[11px] font-medium uppercase tracking-wide2 text-navy-900 hover:border-navy-900"
              >
            ...
            <div className="lg:col-span-8">
              ...
              <ul className="grid gap-px bg-navy-100 sm:grid-cols-2">
                {SERVICE_USES[type].map((use, i) => (
                  <li key={use} className="flex items-baseline gap-3 bg-white py-3.5 pr-4">
                    <span className="font-mono text-[10px] tabular-nums text-navy-300">
